...
We state this for two reasons. The Lean community requires disclosure of AI
assistance and we are guests there. And it is the seminar's own subject matter:
a machine can check that a proof establishes a statement, and cannot check that
the statement says what was meant. That second job is why a human's name is on
this.
